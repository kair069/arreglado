document.addEventListener("DOMContentLoaded", function () {
    ...
    const apiUrl = "https://backendalex.azurewebsites.net/ventas";
...
function eliminarVenta(id) {
    ...
    if (confirm("¿Estás seguro de que deseas eliminar esta venta?")) {
        const apiUrl = `https://backendalex.azurewebsites.net/ventas/${id}`;
...
function guardarCambios() {
    ...
    const apiUrl = `https://backendalex.azurewebsites.net/ventas/${ventaActualId}`;
